#!/usr/bin/env python3
"""
ITN_Module_4.pdf: Türkçe PDF üretir.
...
INPUT_PDF = os.path.join(BASE, "ITN_Module_4.pdf")
OUTPUT_PDF = os.path.join(BASE, "ITN_Module_4_TR.pdf")
CACHE_JSON = os.path.join(BASE, "ITN_Module_4_translation_cache.json")
