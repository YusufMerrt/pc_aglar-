#!/usr/bin/env python3
"""
ITN_Module_8.pdf: Türkçe PDF üretir.
...
INPUT_PDF = os.path.join(BASE, "ITN_Module_8.pdf")
OUTPUT_PDF = os.path.join(BASE, "ITN_Module_8_TR.pdf")
CACHE_JSON = os.path.join(BASE, "ITN_Module_8_translation_cache.json")
